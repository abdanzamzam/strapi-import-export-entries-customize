...
Import/Export data from and to your database in just few clicks. Customization plugin for import base64 using CSV for special needs. Official plugin https://www.npmjs.com/package/strapi-plugin-import-export-entries
